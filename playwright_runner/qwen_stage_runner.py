...
from .qwen_recovery import click_retry_if_visible, ensure_qwen_surface, refresh_chat
...
def run_stage_once(
    ...
    home_url: str = "https://chat.qwen.ai/",
) -> tuple[str, dict]:
    metadata = {
        "attempt": 1,
        "retry_count": 0,
    ...
    def _single_attempt():
        nonlocal page
        page = ensure_qwen_surface(page, timeout_ms=timeout_ms, home_url=home_url)
