...
from .inceptionlabs_recovery import click_retry_if_visible, ensure_inceptionlabs_surface, refresh_chat
from .inceptionlabs_session import (
    assistant_turns,
    find_chat_composer,
    send_prompt,
    stabilize_response,
...
def run_stage_once(
    ...
    home_url: str = "https://chat.inceptionlabs.ai/",
) -> tuple[str, dict]:
    metadata = {
        "attempt": 1,
        "retry_count": 0,
    ...
    def _single_attempt():
        nonlocal page
        page = ensure_inceptionlabs_surface(page, timeout_ms=timeout_ms, home_url=home_url)
