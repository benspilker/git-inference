...
from .updf_deepseek_recovery import click_retry_if_visible, ensure_updf_deepseek_surface, refresh_chat
from .updf_deepseek_session import (
    assistant_turns,
    find_chat_composer,
    send_prompt,
    stabilize_response,
...
def run_stage_once(
    ...
    home_url: str = "https://ai.updf.com/new-chat/",
) -> tuple[str, dict]:
    metadata = {
        "attempt": 1,
        "retry_count": 0,
    ...
    def _single_attempt():
        nonlocal page
        page = ensure_updf_deepseek_surface(page, timeout_ms=timeout_ms, home_url=home_url)
