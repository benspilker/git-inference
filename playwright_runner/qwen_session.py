...
def assistant_turns(page):
    ...
    for selector in selectors:
        ...
        try:
            ...
            continue
    return page.locator(".qwen-chat-message-assistant")
...
def send_prompt(page, composer, prompt_text: str) -> None:
    ...
    send_selectors = [
        ...
        ".message-input-right-button-send button.send-button:not(.disabled):not([disabled])",
...
def stabilize_response(
    ...
    while waited < max_settle_wait_seconds:
        ...
        try:
            ...
            pass
        try:
            current = _normalize(assistant_messages.last.inner_text())
        except Exception:
            current = ""
