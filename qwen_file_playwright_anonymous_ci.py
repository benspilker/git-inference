#!/usr/bin/env python3
"""Stage-capable Playwright runner for Qwen guest browser execution."""
...
from playwright_runner.qwen_recovery import ensure_qwen_surface, refresh_chat, start_new_chat_if_available
from playwright_runner.qwen_stage_runner import run_stage_once, write_stage_outputs
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run a named Playwright stage against Qwen as guest.")
    ...
    parser.add_argument("--user-data-dir", default=".playwright-qwen-profile")
    ...
    parser.add_argument("--network-log-file", default="qwen_network.log")
    parser.add_argument("--error-screenshot", default="qwen_playwright_error.png")
...
def run() -> int:
    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            page = ensure_qwen_surface(page, timeout_ms=args.timeout_ms, home_url=args.url)
