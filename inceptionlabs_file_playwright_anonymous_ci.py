#!/usr/bin/env python3
"""Stage-capable Playwright runner for Inception Labs guest browser execution."""
...
from playwright_runner.inceptionlabs_recovery import ensure_inceptionlabs_surface, refresh_chat, start_new_chat_if_available
from playwright_runner.inceptionlabs_stage_runner import run_stage_once, write_stage_outputs
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run a named Playwright stage against Inception Labs as guest.")
    ...
    parser.add_argument("--url", default="https://chat.inceptionlabs.ai/")
    ...
    parser.add_argument("--user-data-dir", default=".playwright-inceptionlabs-profile")
    ...
    parser.add_argument("--network-log-file", default="inceptionlabs_network.log")
    parser.add_argument("--error-screenshot", default="inceptionlabs_playwright_error.png")
...
def run() -> int:
    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            page = ensure_inceptionlabs_surface(page, timeout_ms=args.timeout_ms, home_url=args.url)
