...
export ALL_SEQUENTIAL_MODELS=git-inceptionlabs,git-chatgpt,git-grok,git-qwen,git-perplexity,git-updf-deepseek
export ALL_PARALLEL_MODELS=git-inceptionlabs,git-chatgpt,git-grok,git-qwen,git-perplexity,git-updf-deepseek
