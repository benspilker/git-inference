#!/usr/bin/env python3
"""Stage-capable Playwright runner for UPDF DeepSeek guest browser execution."""
...
from playwright_runner.updf_deepseek_recovery import ensure_updf_deepseek_surface, refresh_chat, start_new_chat_if_available
from playwright_runner.updf_deepseek_stage_runner import run_stage_once, write_stage_outputs
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run a named Playwright stage against UPDF DeepSeek as guest.")
    ...
    parser.add_argument("--url", default="https://ai.updf.com/new-chat/")
    ...
    parser.add_argument("--user-data-dir", default=".playwright-updf-deepseek-profile")
    ...
    parser.add_argument("--network-log-file", default="updf_deepseek_network.log")
    parser.add_argument("--error-screenshot", default="updf_deepseek_playwright_error.png")
...
def run() -> int:
    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            page = ensure_updf_deepseek_surface(page, timeout_ms=args.timeout_ms, home_url=args.url)
