...
OPENCLAW_DEFAULT_MODEL="${OPENCLAW_DEFAULT_MODEL:-git-parallel}"
OPENCLAW_FORCE_DEFAULT_MODEL="${OPENCLAW_FORCE_DEFAULT_MODEL:-true}"
ALLPARALLEL_VIRTUAL_TURNS_ENABLED="${ALLPARALLEL_VIRTUAL_TURNS_ENABLED:-true}"
ALLPARALLEL_VIRTUAL_TURNS_SEND_FAILURES="${ALLPARALLEL_VIRTUAL_TURNS_SEND_FAILURES:-true}"
...
export OPENCLAW_FORCE_DEFAULT_MODEL
export ALLPARALLEL_VIRTUAL_TURNS_ENABLED
export ALLPARALLEL_VIRTUAL_TURNS_SEND_FAILURES
...
echo "  HOST=${HOST}"
echo "  PORT=${PORT}"
echo "  OPENCLAW_DEFAULT_MODEL=${OPENCLAW_DEFAULT_MODEL}"
echo "  OPENCLAW_FORCE_DEFAULT_MODEL=${OPENCLAW_FORCE_DEFAULT_MODEL}"
echo "  ALLPARALLEL_VIRTUAL_TURNS_ENABLED=${ALLPARALLEL_VIRTUAL_TURNS_ENABLED}"
echo "  ALLPARALLEL_VIRTUAL_TURNS_SEND_FAILURES=${ALLPARALLEL_VIRTUAL_TURNS_SEND_FAILURES}"
