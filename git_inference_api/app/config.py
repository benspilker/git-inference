...
class Settings:
    ...
    router_stage_timeout_seconds: int = int(os.getenv("ROUTER_STAGE_TIMEOUT_SECONDS", "120"))
    ...
    # Model config
    available_models_csv: str = env_csv("AVAILABLE_MODELS", "git-chatgpt-json,git-chatgpt")
    openclaw_compat_models_csv: str = env_csv("OPENCLAW_COMPAT_MODELS", "git-chatgpt")
