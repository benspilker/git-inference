...
class Settings:
    ...
    # Model config
    available_models_csv: str = env_csv("AVAILABLE_MODELS", "git-chatgpt-json,git-chatgpt,git-perplexity,git-gemini")
    openclaw_compat_models_csv: str = env_csv("OPENCLAW_COMPAT_MODELS", "git-chatgpt,git-perplexity,git-gemini")
